...
class Dlib_Frontal_Face_Detector(alpha_detector_squares_base.Detector_Squares_Base):
    f_id = '{94B79EFA-46FF-43C1-97C7-A9A9B5839B03}'
    f_version = 1
    ...
    def process_frame(self, frame_index, image, height, width, Items, value_last):
        ...
        # faces.
        dets = detector(gray, self.f_params['upsample_count'])
